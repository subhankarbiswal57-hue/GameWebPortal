...
export function init3DIntro(onComplete) {
  ...
  function triggerTransition() {
    ...
    try { sound.init(); sound.playVictory(); } catch(e) {}
  ...
  try {
    ...
    // 3D Ancient Aztec Gold Medallion Emblem Group
    ...
    console.error('Three.js init error, falling back', err);
  }
}
